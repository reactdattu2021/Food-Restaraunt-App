...
const Banner = () => {
  ...
  return (
    <div className="relative">
      ...
      >
        <div className="inset-0 bg-gradient-to-r from-amber-900/20 to-amber-700/10">
          <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-12 relative z-10">
            ...
            <div className="flex-1 space-y-8 relative md:pr-8 lg:pr-19 text-center md:text-left">
              ...
              >
                ...
                >
                  ...
                  <input
                    ...
                    className=" w-full py-4 pr-6 bg-transparent outline-none placeholder-amber-200/70
                  text-lg font-medium tracking-wide"
                  ></input>
                  <button
                    type="submit"
                    className="mr-4 px-6 py-3 bg-gradient-to-r from-amber-400 to-amber-300 rounded-lg
                  font-semibold text-amber-900 hover:from-amber-300 hover:to-amber-200 transition-all duration-300 shadow-lg
              ...
              <div className="flex flex-wrap gap-4 justify-center md:justify-start mt-6">
                ...
                rounded-xl transition-all duration-300 border-2 border-amber-700/50 hover:border-amber-400 backdrop-blur-sm"
                >
            ...
            <div className="flex-1 relative group mt-8 md:mt-0 min-h-[300px] sm:min-h-[400px]">
              ...
              >
                <img
                  src={bannerImage}
                  alt="banner"
                  className="rounded-full border-4 xs:border-8 border-amber-900/50 w-full h-full
                object-cover object-top"
                />
                <div className="inset-0 rounded-full bg-gradient-to-b from-transparent"></div>
              </div>
              {/* orbital image */}
