        ...
        to-[#3e2b1d]'>
            <div className=' max-w-7xl mx-auto'>
                <h1 className=' text-4xl sm:text-5xl md:text-6xl font-bold text-center mb-12 animate-fade-in-down'>
                    <span className=' font-dancingscript block text-5xl sm:text-6xl md:text-7xl mb-2 bg-gradient-to-r from-amber-200
                        ...
                        <div className=' mt-12 pt-8 border-t border-amber-800/30 animate-fade-in-up'>
                            <div className=' flex flex-col sm:flex-row justify-between items-center gap-8'>
                                ...
                                <div className=' flex items-center gap-8'>
                                    ...
                                    <button className=' bg-amber-900/40 px-8 py-3 rounded-full font-cinzel uppercase
