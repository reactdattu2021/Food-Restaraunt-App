...
const Navbar = () => {
  ...
  // combined update login modal and auth status on locations change
        ...
        >
          <div className="px-4 py-4 space-y-2">
            {navLinks.map((link) => (
              ...
              >
                <span className="mr-0 text-amber-500">{link.icon}</span>
                {link.name}
              </NavLink>
            ))}
            <div className="pt-4 border-t-2 border-amber-900/30 space-y-2">
              <NavLink
                ...
                className="w-full px-4 py-3 text-center text-amber-100 rounded-xl border-2 border-amber-900/30 hover:border-amber-600/50 flex
                              items-center justify-start space-x-2 text-sm"
              >
